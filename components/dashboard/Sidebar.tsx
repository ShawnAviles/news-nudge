	...
	return (
		<>
			...
			<div className="hidden lg:block lg:w-64">
				{/* This outer div defines the width and visibility only */}
				<div className="sticky top-0 h-screen">
					{/* This div makes it stick to the top and maintains full height */}
					<div className="flex h-full flex-col gap-y-5 overflow-y-auto bg-white border-r border-gray-200 pt-3 px-6 pb-4">
			...
			<div
				className={cn(
					"fixed inset-y-0 z-45 flex w-64 flex-col transition-transform duration-300 ease-in-out lg:hidden",
